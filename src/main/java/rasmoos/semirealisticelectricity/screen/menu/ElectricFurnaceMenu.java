...
public class ElectricFurnaceMenu extends MachineMenu {
    ...
    public ElectricFurnaceMenu(int pContainerId, Inventory inv, MachineBlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ELECTRIC_FURNACE_MENU.get(), pContainerId, inv, entity, data);
    }
