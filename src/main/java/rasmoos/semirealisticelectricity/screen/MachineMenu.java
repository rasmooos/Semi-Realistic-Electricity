...
public abstract class MachineMenu extends AbstractContainerMenu {
    ...
    protected final MachineBlockEntity entity;

    public MachineMenu(MenuType<?> menuType, int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(menuType, pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()));
    }

    public MachineMenu(MenuType<?> menuType, int pContainerId, Inventory inv, BlockEntity entity) {
        ...
        this.entity = (MachineBlockEntity) entity;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, entity.getBlockPos()),
                pPlayer, ModBlocks.IRON_FURNACE_BLOCK.get());
    }
